      ...
      <View className="p-4 gap-y-4">
        ...
        <View className="flex flex-row items-center gap-x-0">
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity className="flex flex-col gap-y-1 justify-center ml-3 items-center">
                <View className="w-[52px] h-[52px] bg-zinc-200 rounded-full items-center justify-center overflow-hidden border border-zinc-100">
                  <Image source={{ uri: item.image }} width={52} height={52} alt='h-[52px]' className='rounded-full w-[52px] relative' />
